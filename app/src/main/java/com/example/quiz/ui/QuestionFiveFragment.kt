...
class QuestionFiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_question_five, container, false)

        questionText = root.findViewById(R.id.question_five)
        optionOne = root.findViewById(R.id.answer_five_check_box_one)
        optionTwo = root.findViewById(R.id.answer_five_check_box_two)
        optionThree = root.findViewById(R.id.answer_five_check_box_three)
        optionFour = root.findViewById(R.id.answer_five_check_box_four)
        nextQuestion = root.findViewById(R.id.question_five_screen_next_image)
    ...
    private fun showScoreScreen() {
        ...
        val directions =
            QuestionFiveFragmentDirections.actionQuestionFiveFragmentToFinalScoreFragment(
                optionOneSelected,
                optionTwoSelected,
                optionThreeSelected,
                optionFourSelected
