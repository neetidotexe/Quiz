...
class QuestionFourFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_question_four, container, false)

        questionText = root.findViewById(R.id.question_four)
        optionOne = root.findViewById(R.id.answer_four_check_box_one)
        optionTwo = root.findViewById(R.id.answer_four_check_box_two)
        optionThree = root.findViewById(R.id.answer_four_check_box_three)
        optionFour = root.findViewById(R.id.answer_four_check_box_four)
        nextQuestion = root.findViewById(R.id.question_four_screen_next_image)
