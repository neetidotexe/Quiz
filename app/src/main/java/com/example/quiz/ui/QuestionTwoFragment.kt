...
class QuestionTwoFragment : Fragment() {
    ...
    lateinit var optionThree: RadioButton
    lateinit var optionFour: RadioButton
    ...
    override fun onCreateView(
        ...
        optionOne = root.findViewById(R.id.answer_two_radio_button_one)
        optionTwo = root.findViewById(R.id.answer_two_radio_button_two)
        optionThree = root.findViewById(R.id.answer_two_radio_button_three)
        optionFour = root.findViewById(R.id.answer_two_radio_button_four)
